...
namespace AspNetIdentitySample.Test.Unit.Binding
{
    ...
    using AspNetIdentitySample.Test.Unit.Controllers;
...
#pragma warning restore CS8618
        ...
        public void Initialize()
        {
            ...
            _stringPropertyForBodyMetadataMock.SetupGet(metadata => metadata.PropertySetter)
                                              .Returns((a, b) => ((TestViewModel)a).StringPropertyForBody = (string)b!)
                                              .Verifiable();
            ...
            _guidPropertyForBodyMetadataMock.SetupGet(metadata => metadata.PropertySetter)
                                            .Returns((a, b) => ((TestViewModel)a).GuidPropertyForBody = (Guid)b!)
                                            .Verifiable();
            ...
            _stringPropertyForRouteMetadataMock.SetupGet(metadata => metadata.PropertySetter)
                                               .Returns((a, b) => ((TestViewModel)a).StringPropertyForRoute = (string)b!)
                                               .Verifiable();
            ...
            _guidPropertyForRouteMetadataMock.SetupGet(metadata => metadata.PropertySetter)
                                            .Returns((a, b) => ((TestViewModel)a).GuidPropertyForRoute = (Guid)b!)
                                            .Verifiable();
            ...
            _stringPropertyForQueryStringMetadataMock.SetupGet(metadata => metadata.PropertySetter)
                                               .Returns((a, b) => ((TestViewModel)a).StringPropertyForQueryString = (string)b!)
                                               .Verifiable();
            ...
            _guidPropertyForQueryStringMetadataMock.SetupGet(metadata => metadata.PropertySetter)
                                            .Returns((a, b) => ((TestViewModel)a).GuidPropertyForQueryString = (Guid)b!)
                                            .Verifiable();
